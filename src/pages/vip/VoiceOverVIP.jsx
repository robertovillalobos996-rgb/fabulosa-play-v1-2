    ...
    <div className="min-h-screen bg-zinc-950 text-white overflow-x-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto p-6 md:p-12 grid grid-cols-1 lg:grid-cols-12 gap-12">
        <div className="lg:col-span-4 flex flex-col gap-8">
          <div className="bg-zinc-900/50 p-10 rounded-[3rem] border border-white/5 shadow-2xl flex justify-center items-center"><img src="/voice_over.png" alt="Voice Over" className="w-full max-w-[250px] object-contain" /></div>
          ...
          <div className="flex flex-wrap gap-3">
            <button className="flex-1 bg-white/5 p-3 rounded-xl flex items-center justify-center"><Instagram size={20} /></button>
            <button className="flex-1 bg-white/5 p-3 rounded-xl flex items-center justify-center"><Globe size={20} /></button>
            <button className="flex-1 bg-white/5 p-3 rounded-xl flex items-center justify-center"><Mail size={20} /></button>
            <button className="flex-1 bg-white/5 p-3 rounded-xl flex items-center justify-center"><Download size={20} /></button>
          </div>
        </div>
        <div className="lg:col-span-8 flex flex-col">
          ...
          <div className="relative w-full aspect-video rounded-[2rem] overflow-hidden border border-white/10 bg-black shadow-2xl"><video ref={videoRef} controls autoPlay muted className="w-full h-full object-cover" /></div>
          <div className="mt-8 grid grid-cols-2 gap-4">
             <div className="bg-zinc-900/50 aspect-video rounded-2xl border border-white/5 flex items-center justify-center text-gray-500 font-bold uppercase text-[10px]">Espacio Cámara 1</div>
             <div className="bg-zinc-900/50 aspect-video rounded-2xl border border-white/5 flex items-center justify-center text-gray-500 font-bold uppercase text-[10px]">Galería Fotos</div>
          </div>
        </div>
      </div>
    </div>
