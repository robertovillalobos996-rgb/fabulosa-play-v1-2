...
const Home = () => {
  ...
  const cards = [
    ...
    { id: 'ranchera', path: '/ranchera', img: cardVerano }, 
    { id: 'movies', path: '/cine-play', img: cardMovies },
    { id: 'tv', path: '/canales-play', img: cardTv },
    ...
    <div className="flex flex-col h-screen overflow-hidden text-white relative">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <video autoPlay loop muted playsInline className="w-full h-full object-cover opacity-40">
          <source src="https://assets.mixkit.co/videos/preview/mixkit-abstract-technology-connection-lines-loop-27415-large.mp4" type="video/mp4" />
        </video>
      </div>
    </div>
  );
